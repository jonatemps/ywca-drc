                ...
                <div class="row">
                    ...
                    <div class="col-xl-7">
                        <div class="about-style2-image-box">
                            ...
                            <div class="image">
                                <img src="images\proprio\sensibilisation1.jpg" alt="Awesome Image">
                                <div class="overlay-box">
                                    <div class="title">
                                        <h1>{{date("Y",time()) - 2001}}<span> Ans d'expérience<br> à l'oeuvre.</span></h1>
                                    </div>
                                    <div class="button">
                                        <a href="{{route('home')}}"><span class="icon-back"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="sec-title float-left">
                            <p>Informations & Mis à jours</p>
                            <div class="title">Récents au <span>Blog</span></div>
                        </div>
                        <div class="more-blog-button float-right">
                            <a class="btn-two" href="{{route('posts')}}">Voir Plus<span class="flaticon-next"></span></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="single-blog-post wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="text-holder">
                                ...
                                <div class="text">
                                    ...
                                    <a class="btn-two" href="{{route('post',['title' => $post->title,'id' => $post->id])}}">Lire plus<span class="flaticon-next"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
